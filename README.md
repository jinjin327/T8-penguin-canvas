...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v1.4.9
>
...
![status](https://img.shields.io/badge/version-v1.4.9-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
产物：`dist_electron/T8-PenguinCanvas-Setup-<version>.exe`（v1.4.9 打包后以实际产物大小为准）
