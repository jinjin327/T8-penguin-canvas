...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v2.2.1
>
...
![status](https://img.shields.io/badge/version-v2.2.1-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🚀 **v2.2.1 源码版**：只推 GitHub 源码，不打包 Electron、不发布 Release；继续收口灵感之源「艺术风格大师 / 动漫标签大师」、资源库分类、RH 工具箱映射、图像裁切比例、任务提示音、输出素材持久化、Codex / 生图工作台输入预览与俄罗斯方块主题细节
